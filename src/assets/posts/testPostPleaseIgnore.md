It only took me a few months to remember I had this project on the back burner but I finally got it all worked out; this site contains something that resembles a blog! I've wanted to add this for a while as an isolated platform for sharing some personal projects that I've been working on but I've been a bit preoccupied working on those projects. Bit of a Catch-22 but that's what happens when I have a lot of projects I'm enthusiastic about.

## The Why
So why make a blog? Better yet, why make a blog _like this_? Why not use a big platform with easy reach to a wide audience and actual engagement tools like Substack? Why not use a blog library for Angular and avoid doing all this manual work? Why go to all the trouble of hand rolling this fully custom blog directory and deeplink system? Because I feel like it, that's why. Okay maybe that's not the whole story but that's about 80% of it. 
...
- You want to know if I'm a competent
  ...
  - Bowler ⚠️
  - Human being ✅
- You have a real interest in one of the other aspects of my website
